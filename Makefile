...
#                                                 +#+#+#+#+#+   +#+             #
#    Created: 2026/05/29 00:00:00 by ifreire           #+#    #+#               #
#    Updated: 2026/05/29 00:00:00 by ifreire          ###   ########.fr         #
#                                                                              #
# **************************************************************************** #
...
SRCS	= ft_isascii.c ft_isalnum.c ft_isalpha.c ft_isdigit.c ft_isprint.c \
		  	...
		  	ft_memmove.c ft_memchr.c ft_memcmp.c ft_calloc.c ft_strlen.c \
		  	ft_strlcpy.c ft_strlcat.c ft_strchr.c ft_strrchr.c ft_strncmp.c \
		  	ft_strnstr.c ft_strdup.c ft_atoi.c ft_substr.c \
# 		  ft_strjoin.c \
# 		  ft_strtrim.c \
# 		  ft_split.c \
# 		  ft_itoa.c \
